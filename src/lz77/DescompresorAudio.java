 ...
 * @author levanna
 */
public class DescompresorAudio {
    
    private final int ment;
    private final int mdes;
    private final int l;
    private final int d;
    private String asciiDescomprimido;
    ...
    public String descomprimirString(String descodificar){
        ...
        while(!acabar){         
            ...
            //System.out.println("Descomprimida = "+asciiDescomprimido);
        ...
        this.asciiDescomprimido = this.quitarBits(asciiDescomprimido); //Quitamos los bits añadidos al hacer la compresion
                                        // que permiten hacer referencia a 0s o 1s en caso de que haya demasiados iguales seguidos
        StringBuffer buffer = new StringBuffer(this.asciiDescomprimido);
        this.stringDescomprimido = (txtReader.ASCIIbin2string(buffer)).toString();
        return this.asciiDescomprimido; 
    }
    ...
    public void descomprime(String string){
        this.asciiDescomprimido += string;
    }
    ...
    private void print(String patron) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public String getStringDescomprimido() {
        return stringDescomprimido;
    }
}
